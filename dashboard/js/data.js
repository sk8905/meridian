...
export const EQ_INDICES = [
  { id: "spx",  name: "S&P 500",         region: "US",     level: 7509.20,  ytd: 9.6,   asOf: "2026-07-21", stooq: "^spx",   source: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-july-20-2026", keyMoment: { text: "Chair Warsh delivered a hawkish first Jackson Hole keynote, declining to rule out a hike and saying the Fed will 'have work to do' if inflation doesn't return to 2%; CME FedWatch-implied odds of a 16 September hike rose to roughly 46-50% while the S&P 500 held roughly flat into the close.", src: "https://www.cnbc.com/2026/08/28/kevin-warsh-jackson-hole-federal-reserve-inflation.html", srcName: "CNBC", date: "2026-08-28" } },
  { id: "ndq",  name: "Nasdaq Composite", region: "US",    level: 25837.21, ytd: 10.2,  asOf: "2026-07-21", stooq: "^ndq",   source: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-july-20-2026", keyMoment: { text: "Chair Warsh delivered a hawkish first Jackson Hole keynote, declining to rule out a hike and saying the Fed will 'have work to do' if inflation doesn't return to 2%; CME FedWatch-implied odds of a 16 September hike rose to roughly 46-50% while the S&P 500 held roughly flat into the close.", src: "https://www.cnbc.com/2026/08/28/kevin-warsh-jackson-hole-federal-reserve-inflation.html", srcName: "CNBC", date: "2026-08-28" } },
  { id: "dji",  name: "Dow Jones",        region: "US",     level: 52224.64, ytd: 9.4,   asOf: "2026-07-21", stooq: "^dji",   source: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-july-20-2026", keyMoment: { text: "Chair Warsh delivered a hawkish first Jackson Hole keynote, declining to rule out a hike and saying the Fed will 'have work to do' if inflation doesn't return to 2%; CME FedWatch-implied odds of a 16 September hike rose to roughly 46-50% while the S&P 500 held roughly flat into the close.", src: "https://www.cnbc.com/2026/08/28/kevin-warsh-jackson-hole-federal-reserve-inflation.html", srcName: "CNBC", date: "2026-08-28" } },
