...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-08",
      time: "21:24 BST",
      lede: "Legal logs a run of new public-M&amp;A mandates into Tuesday's close &mdash; Freshfields advising Spire Healthcare on its recommended &pound;1.03bn acquisition by a Toscafund/THCP/Ares-backed consortium (with Slaughter and May on the other side for shareholder Mediclinic), and Kirkland &amp; Ellis advising the HYROX founders on their tie-up with an L Catterton-led group to regain control of the fitness brand from Infront &mdash; while credit adds M&amp;G's hire of Jen Braswell as global head of impact for its &pound;83bn private-markets business and logs V&auml;rde Partners' $850m raised so far for a third Asia credit strategy vintage; macro stays fixed on Brent's push to $98 after Houthi strikes on Saudi energy facilities and Chancellor Healey's renewed insistence that UK borrowing remains too high after Tuesday's gilt sale priced at the highest yield premium since 1998.",
      bullets: [
        { html: "<strong>Legal &mdash; Freshfields advises Spire Healthcare on recommended &pound;1.03bn acquisition by Toscafund-led consortium</strong>: Freshfields acted for Spire Healthcare Group on its recommended takeover by Tulip UK Bidco, a vehicle backed by Toscafund, THCP Advisory and Ares Management, at 250p/share via a court-sanctioned scheme; Slaughter and May separately advised 29.8% shareholder Mediclinic.", src: "https://www.freshfields.com/en/our-thinking/news/news-search/2026/09/freshfields-advises-spire-healthcare-on-1bn-acquisition-by-toscafund-led-consortium", srcName: "Freshfields" },
        { html: "<strong>Legal &mdash; Kirkland &amp; Ellis advises HYROX founders on partnership with L Catterton-led consortium</strong>: the firm acted for founders Christian Toetzke and Moritz F&uuml;rste as an L Catterton/WndrCo-led group agreed to acquire Infront Sports &amp; Media's majority stake in the hybrid-racing fitness brand, returning control to its founders.", src: "https://www.kirkland.com/news/press-release/2026/09/kirkland-advises-hyrox-founders-on-partnership-with-l-catterton-led-consortium", srcName: "Kirkland & Ellis" },
        { html: "<strong>Credit &mdash; M&amp;G hires Jen Braswell as global head of impact for its &pound;83bn private-markets business</strong>: Braswell, previously senior impact adviser to M&amp;G affiliate responsAbility and formerly of EQT and British International Investment, will report to private-markets CIO Emmanuel Deblanc.", src: "https://alternativecreditinvestor.com/2026/09/08/mg-hires-head-of-impact-for-alts-business/", srcName: "Alternative Credit Investor" },
        { html: "<strong>Credit &mdash; V&auml;rde Partners secures $850m for third Asia credit strategy vintage</strong>: the strategy, targeting roughly $1bn, invests across corporate credit, special-situations lending and stressed/distressed real estate in India, Australia and Southeast Asia, following V&auml;rde's debut ~$400m Asia Credit Fund closed in 2018.", src: "https://www.pei-privatecredit.com/varde-partners-secures-850m-for-asia-credit-strategy/", srcName: "PEI Private Credit" },
        { html: "<strong>Macro &mdash; Brent climbs to $98 after Houthi allies strike Saudi energy facilities</strong>: crude extended its advance as attacks hit multiple Saudi energy sites, adding a fresh geopolitical premium on top of an already-tense Gulf backdrop.", src: "https://www.cnbc.com/2026/09/08/oil-prices-today-brent-wti-hormuz-iran-war.html", srcName: "CNBC" },
        { html: "<strong>Macro &mdash; Healey says UK borrowing remains too high as fiscal discipline takes priority</strong>: the Chancellor's comments came a day after a gilt syndication priced at the highest yield premium since 1998, keeping investor focus on the arithmetic ahead of the 28 October Budget.", src: "https://www.bloomberg.com/news/articles/2026-09-08/healey-says-uk-borrowing-too-high-in-signal-of-fiscal-rigor", srcName: "Bloomberg" },
      ],
    },
  },
};
