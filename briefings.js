...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-08-23",
      time: "05:21 BST",
      lede: "Brent settled Friday at $94.39/bbl, its best weekly close since 24 July, after Trump threatened sanctions on Iran's trading partners and Tehran vowed a 'devastating' response ahead of Bessent's Monday sanctions announcement, while Fed Chair Kevin Warsh prepares his first Jackson Hole keynote and UK data showed employment declining as price pressures mount; in legal, Slaughter and May advised Fortuna Mining on its acquisition of the Bambadji gold-exploration project from Barrick and IAMGOLD, and the High Court handed down a pre-incorporation-contract ruling in Evans v JNP Group Consulting Engineers.",
      bullets: [
        ...
        { html: "<strong>Legal &mdash; Slaughter and May/Fortuna Mining</strong>: Slaughter and May advised Fortuna Mining on its acquisition of the Bambadji gold-exploration project in Senegal from Barrick and IAMGOLD.", src: "https://www.slaughterandmay.com/recent-work/fortuna-mining-on-its-acquisition-of-the-bambadji-exploration-project-from-barrick-and-iamgold/", srcName: "Slaughter and May" },
        { html: "<strong>Legal &mdash; case law</strong>: The High Court (Comm) ruled in <em>Evans &amp; Ors v JNP Group Consulting Engineers Ltd</em> [2026] EWHC 2175 (Comm), a section 51 Companies Act 2006 dispute over liability on a pre-incorporation contract.", src: "https://caselaw.nationalarchives.gov.uk/ewhc/comm/2026/2175", srcName: "National Archives" },
      ],
    },
    afternoon: {
      label: "Afternoon",
