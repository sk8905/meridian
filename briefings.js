...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-10",
      time: "05:16 BST",
      lede: "The dollar drifts toward a seven-month low and US equities close lower for a third session as Brent holds above $100 and the 10-year Treasury yield sits at its highest since 2023, with record UK gilt yields and Fed-hike odds near 50% setting up a combustible run into next week's back-to-back FOMC and BoE decisions.",
      bullets: [
        { html: "<strong>Macro &mdash; Dollar eyes a seven-month low</strong>: the greenback wobbled as traders weighed the US Treasury's tripled long-bond buyback programme against the countdown to next week's FOMC decision, with Chair Warsh's hawkish post-Jackson Hole tone still driving the debate.", src: "https://www.bloomberg.com/news/articles/2026-09-09/dollar-eyes-seven-month-low-with-us-buybacks-inflation-in-focus", srcName: "Bloomberg" },
        { html: "<strong>Equities &mdash; US stocks sink for a third session as oil and yields jump</strong>: the Dow, S&amp;P 500 and Nasdaq all closed lower as Brent's push above $100 and a 10-year Treasury yield rise to 4.84% &mdash; its highest since October 2023 &mdash; on the back of the Treasury's buyback announcement weighed on risk appetite.", src: "https://ca.finance.yahoo.com/news/stock-market-today-wednesday-september-9-dow-sp-500-nasdaq-futures-080411279.html", srcName: "Yahoo Finance / Reuters" },
        ...
        { html: "<strong>Macro &mdash; the Fed's three choices as Warsh's honeymoon ends</strong>: with hike odds near 50&ndash;60% into the 15&ndash;16 September FOMC, commentary frames Chair Warsh as caught between White House pressure to cut, credibility pressure to hold, and the inflation case markets are now pricing for a hike.", src: "https://www.bloomberg.com/opinion/articles/2026-09-09/the-fed-s-three-choices-as-warsh-s-honeymoon-ends", srcName: "Bloomberg Opinion" },
