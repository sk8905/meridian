...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-12",
      time: "05:24 BST",
      lede: "Wall Street closed a losing week on a high note despite a hotter-than-expected August core CPI that pushed Fed-hike odds for Wednesday's FOMC to around 90%, sterling held its GDP-driven gains against a firmer dollar, and a still-jittery gilt market keeps Chancellor Healey's Budget arithmetic under pressure into the weekend.",
      bullets: [
        ...
        { html: "<strong>Macro &mdash; hot August core CPI pushes Fed-hike odds to about 90% for Wednesday's FOMC</strong>: core prices rose 0.3% m/m, a tenth above forecast, in the last major data point before the decision &mdash; bolstering the case for Chair Kevin Warsh's Fed to raise rates.", src: "https://www.bloomberg.com/news/articles/2026-09-11/us-core-cpi-rises-more-than-forecast-bolstering-case-for-hike", srcName: "Bloomberg" },
        ...
        { html: "<strong>Macro &mdash; dollar wavers as hot US inflation firms Fed-hike bets while sterling holds its gains</strong>: the dollar wavered as the hotter core CPI reinforced hike expectations even as falling oil capped its advance, while sterling held Friday's rally after the surprise 0.4% UK July GDP beat put Britain on track for the fastest H1 2026 growth in the G7.", src: "https://www.bloomberg.com/news/articles/2026-09-11/dollar-wavers-as-inflation-aids-fed-hike-bets-while-oil-falls", srcName: "Bloomberg" },
