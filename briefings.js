...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-08-16",
      time: "17:15 BST",
      lede: "Iran struck another tanker in the Strait of Hormuz as Israel stepped up strikes on Lebanon, an AI-driven memory-chip shortage began feeding into UK inflation, and this run added a new agriculture-focused private credit manager plus a Sidley update on the FCA's proposed AIFM capital regime to Meridian Credit and Legal.",
      bullets: [
        { html: "<strong>Geopolitics &mdash; Hormuz</strong>: Iran struck another vessel in the Strait of Hormuz as Israel stepped up attacks on Lebanon, keeping the blockade and its oil-driven inflation risk live into the weekend.", src: "https://www.cbsnews.com/live-updates/iran-war-donald-trump-strait-of-hormuz-uae-accuses-attacks-vance-oil-gas/", srcName: "CBS News" },
        { html: "<strong>Macro &mdash; UK inflation</strong>: an AI-driven global memory-chip shortage is starting to wash into the UK economy, adding a fresh cost-push element to the Bank of England's inflation watch.", src: "https://www.bloomberg.com/news/articles/2026-08-15/ai-chipflation-washes-ashore-in-the-uk-economy", srcName: "Bloomberg" },
        { html: "<strong>Credit &mdash; Homestead Capital</strong>: the San Francisco farmland manager joined Meridian Credit's tracked-manager roster after holding a $150m first close, against a $350m target, for its inaugural US agriculture private-credit fund.", src: "https://alternativecreditinvestor.com/2026/08/14/homestead-secures-significant-commitments-at-first-close-of-agri-private-credit-fund/", srcName: "Alternative Credit Investor" },
        { html: "<strong>Credit &mdash; LGT Capital Partners</strong>: LGT launched its debut credit secondaries strategy, targeting LP-led, GP-led and opportunistic deals with an emphasis on senior lending &mdash; backfilled into Meridian Credit's Fundraising Intelligence feed.", src: "https://www.pei-privatecredit.com/lgt-capital-partners-launches-debut-credit-secondaries-strategy/", srcName: "PEI Private Credit" },
        { html: "<strong>Legal &mdash; funds regulation</strong>: Sidley's August update flags the FCA's proposed three-tier, NAV-based capital regime for AIFMs and new MiFIR transaction-reporting cuts estimated to save the industry &pound;108m a year.", src: "https://www.sidley.com/en/insights/newsupdates/2026/08/uk-eu-investment-management-update-august-2026", srcName: "Sidley Austin" },
      ],
    },
  },
};
