...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-13",
      time: "17:19 BST",
      lede: "Markets head into the most consequential week of the year with futures pricing roughly a 90% chance the Fed delivers its first hike since 2023 on Wednesday, the BoE following a day later, and UK borrowing costs already climbing on Budget-arithmetic fears even before either decision lands.",
      bullets: [
        { html: "<strong>Macro &mdash; Fed-hike odds hold near a cycle-high ~90% into Wednesday's FOMC</strong>: economists point to hotter-than-forecast August core CPI, a resilient labour market and Chair Warsh's Jackson Hole conditionality as the case for the Fed's first hike since 2023, with markets already pricing a further move by December.", src: "https://www.forbes.com/sites/bill_stone/2026/09/13/why-the-fed-is-likely-to-raise-rates-this-week/", srcName: "Forbes" },
        { html: "<strong>Equities &mdash; Wall Street heads into the Fed decision unblinking despite war worries</strong>: stocks enter the week near recent highs even as investors weigh the FOMC meeting alongside geopolitical tension, with the coming week's rate decision the dominant catalyst for US indices.", src: "https://finance.yahoo.com/markets/article/a-highly-anticipated-fed-meeting-war-worries-and-an-unblinking-stock-market-what-to-watch-this-week-100000843.html", srcName: "Yahoo Finance" },
        { html: "<strong>Fixed income &mdash; the UK 2-year gilt yield jumps 14bp to 4.72%, its highest since November 2023</strong>: the move stoked talk that Chancellor Healey may need an 'emergency Budget' to close a widening fiscal gap, with the 28 October Budget now shadowed by the surge in short-dated borrowing costs.", src: "https://www.cityam.com/surge-in-borrowing-costs-could-force-healey-to-deliver-emergency-budget/", srcName: "CityAM" },
        { html: "<strong>Macro &mdash; UK fiscal headroom keeps narrowing ahead of the autumn Budget</strong>: analysts flag that higher gilt yields and softer growth assumptions are eating into the Chancellor's already-thin buffer against her fiscal rules, raising the odds of further tax or spending measures next month.", src: "https://www.investing.com/news/economy-news/how-much-has-uk-fiscal-headroom-narrowed-ahead-of-autumn-budget-4897694", srcName: "Investing.com" },
        { html: "<strong>Fixed income &mdash; Treasuries hold near cycle highs as traders price two hikes by year-end</strong>: the 10-year yield remains close to its highest level since 2007 after last week's CPI surprise, with bond traders positioning for a second quarter-point Fed move on top of Wednesday's expected hike.", src: "https://www.bloomberg.com/news/articles/2026-09-11/treasuries-fall-as-higher-than-expected-cpi-boosts-fed-hike-odds", srcName: "Bloomberg" },
      ],
    },
  },
};
