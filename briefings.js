...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-11",
      time: "05:10 BST",
      lede: "Oil holds near multi-year highs and Asia-Pacific equities sell off broadly as the 10-year Treasury yield pushes to 4.97%, with sterling and the dollar both marking time into today's UK GDP print and the decisive US August CPI report that will settle the odds of a 16 September Fed hike.",
      bullets: [
        { html: "<strong>Macro &mdash; decisive CPI day arrives with Fed-hike odds near 70%</strong>: August CPI lands at 8:30am ET as the last major test before the 16 September FOMC, after Thursday's hot PPI print (5.4% y/y) pushed CME FedWatch-implied hike odds up to roughly 70% from about 60% beforehand.", src: "https://247wallst.com/investing/2026/09/10/tomorrows-cpi-report-could-send-rate-hike-odds-even-higher/", srcName: "24/7 Wall St." },
        ...
        { html: "<strong>Fixed income &mdash; 10-year Treasury yield extends to a fresh high of 4.97%</strong>: the move &mdash; its highest since October 2023 &mdash; came as Japan's August producer prices jumped 7.6% y/y, reinforcing bets the BoJ will hike to 1.25% at its own meeting next week.", src: "https://investinglive.com/news/investinglive-asia-pacific-market-news-oil-holds-near-highs/", srcName: "investingLive" },
        { html: "<strong>Macro &mdash; sterling and the dollar mark time ahead of UK GDP and US CPI</strong>: GBP/USD held flat near 1.3510 in early trading as traders stayed on the sidelines for this morning's UK July GDP print and the decisive US inflation data due later in the session.", src: "https://www.fxstreet.com/news/british-pound-holds-steady-above-13500-ahead-of-us-cpi-inflation-release-202609110146", srcName: "FXStreet" },
