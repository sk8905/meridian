...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-16",
      time: "05:11 BST",
      lede: "Decision day: the Fed announces its rate call at 2pm ET (7pm BST) after a Reuters poll found 85% of economists expect a hike, UK August CPI lands this morning ahead of Thursday's BoE meeting, and 30-year gilt yields hover near 6% &mdash; a level last seen in 1998.",
      bullets: [
        { html: "<strong>Macro &mdash; the Fed's rate call lands at 2pm ET (7pm BST) today</strong>, with a Reuters poll of 101 economists finding 85% now expect a quarter-point hike to 3.75-4.00% &mdash; the first increase since July 2023 &mdash; alongside a fresh Summary of Economic Projections.", src: "https://www.kiplinger.com/investing/live/fed-meeting-updates-and-commentary-september-2026", srcName: "Kiplinger" },
        ...
        { html: "<strong>Macro &mdash; UK August CPI is due at 7am today</strong>, the last major UK data point before Thursday's BoE decision, after Tuesday's ONS release showed unemployment steady at 4.9% (below the 5% forecast) even as the economy added just 67,000 jobs, down from 83,000 the prior quarter.", src: "https://www.ons.gov.uk/releases/consumerpriceinflationukaugust2026", srcName: "ONS" },
        { html: "<strong>Fixed income &mdash; UK 30-year gilt yields are hovering near 6%</strong> &mdash; a level last seen in 1998 &mdash; and the 10-year near 5.3-5.4%, as surging oil prices and the UK's exposure to energy shocks keep investors pricing further BoE tightening even as Thursday's meeting is widely expected to be a hold.", src: "https://tradingeconomics.com/united-kingdom/government-bond-yield/news/540938", srcName: "TradingEconomics" },
      ],
    },
    afternoon: {
      label: "Afternoon",
