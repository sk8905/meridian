...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-16",
      time: "17:11 BST",
      lede: "Decision day: US equities pushed higher into the Fed's 2pm ET (7pm BST) rate call as oil eased on a Saudi pipeline-restart pledge, the 10-year Treasury yield still holds above 5% &mdash; its highest since 2007 &mdash; and UK CPI surprised hot at 3.1% a day before Thursday's BoE meeting.",
      bullets: [
        { html: "<strong>Macro &mdash; the Fed's rate call lands at 2pm ET (7pm BST) today</strong>, with hike odds near a cycle-high after a summer of oil-driven inflation surprises and Tuesday's Reuters poll of economists now expecting a move.", src: "https://www.kiplinger.com/investing/live/fed-meeting-updates-and-commentary-september-2026", srcName: "Kiplinger" },
        { html: "<strong>Equities &mdash; the S&amp;P 500 and Nasdaq rose roughly 0.5% and 0.9% respectively Wednesday morning</strong> ahead of the Fed decision, with the Dow also higher, as Brent crude eased back after the U.S. said the damaged Saudi East-West pipeline would restart within days.", src: "https://finance.yahoo.com/markets/live/stock-market-today-wednesday-september-16-dow-sp-500-nasdaq-fed-meeting-decision-080356525.html", srcName: "Yahoo Finance" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield still holds above the 5% threshold</strong> it crossed for the first time since 2007, with money markets treating today's Fed decision as a near-certain hike.", src: "https://www.cnbc.com/2026/09/16/treasury-yield-bond-market-fed-decision.html", srcName: "CNBC" },
        { html: "<strong>Macro &mdash; UK CPI rose to 3.1% y/y in August</strong> (from 2.9% in July), its first reading above 3% since March, landing the morning before Thursday's Bank of England decision where a hold at 3.75% remains the consensus.", src: "https://www.ons.gov.uk/economy/inflationandpriceindices/bulletins/consumerpriceinflation/august2026", srcName: "ONS" },
