...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-08-08",
      time: "05:25 BST",
      lede: "September Fed hike odds kept sliding to roughly 44% after Friday's shock 23,000 nonfarm-payrolls drop even as the Fed's internal split deepened, Saudi Arabia, Turkey and Pakistan signed a NATO-style &lsquo;Mecca Joint Defence Pact&rsquo; the same day Trump said the Iran war &lsquo;can't go much longer&rsquo;, Millennium Management hired natural-gas trader Ryan Sheffler away from a expected Point72 move, and Trinity Capital confirmed Q2 2026 results with $709m of new commitments.",
      bullets: [
        { html: "<strong>US data watch</strong>: CME FedWatch-implied odds of a 16 September Fed hike stayed collapsed near 44% (from ~81% a week earlier) after July nonfarm payrolls unexpectedly fell 23,000 against an +83,000 consensus, with 103,000 of downward May/June revisions.", src: "https://www.cnbc.com/2026/08/07/odds-the-fed-hikes-in-september-tumble-following-big-july-jobs-miss.html", srcName: "CNBC" },
        { html: "<strong>Fed watch</strong>: the internal Fed debate stayed visibly split into the weekend &mdash; Governor Lisa Cook again said she is ready to raise rates if disinflation doesn't resume, even as New York Fed president John Williams called the current stance 'well positioned'.", src: "https://www.bloomberg.com/news/articles/2026-08-07/fed-split-on-rate-hikes-deepens-as-high-inflation-tests-patience", srcName: "Bloomberg" },
        { html: "<strong>Geopolitics</strong>: Saudi Arabia, Turkey and Pakistan signed a NATO Article 5-style 'Mecca Joint Defence Pact' treating an attack on any one signatory as an attack on all, the same day Trump said he believes the Iran war 'can't go much longer' as Tehran and Oman edge toward a Strait of Hormuz shipping framework.", src: "https://www.nbcnews.com/world/middle-east/saudi-arabia-turkey-pakistan-pledge-mutual-defense-rcna591330", srcName: "NBC News" },
        { html: "<strong>Hedge funds</strong>: Millennium Management hired natural-gas trader Ryan Sheffler from Castleton Commodities International, where he spent 14 years as a cross-commodities trader; Sheffler had previously been expected to join Point72's commodities push.", src: "https://www.hedgeweek.com/millennium-lands-natural-gas-trader-ahead-of-point72/", srcName: "Hedgeweek" },
        { html: "<strong>Credit &mdash; BDCs</strong>: Trinity Capital confirmed Q2 2026 results &mdash; total investment income $87.2m (+25.5% y/y), net investment income $46.0m ($0.51/share, +32.1% y/y) and $709m of new commitments originated, taking H1 2026 to $1.1bn of new commitments.", src: "https://www.prnewswire.com/news-releases/trinity-capital-achieves-709-million-of-new-commitments-and-619-million-in-funded-investments-in-the-second-quarter-of-2026-302822277.html", srcName: "PR Newswire" },
      ],
    },
    afternoon: {
      label: "Afternoon",
