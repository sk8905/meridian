...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-14",
      time: "05:10 BST",
      lede: "Markets open the week rattled by dueling AI-slowdown warnings from Anthropic's Amodei and OpenAI's Altman and a fresh oil shock after Saudi Arabia shut its East-West pipeline, with Nasdaq 100 futures down as much as 1.2%, the 10-year Treasury closing in on 5% and Fed-hike odds near 85-86% two days before Wednesday's decision.",
      bullets: [
        { html: "<strong>Macro &mdash; Saudi Arabia shuts its East-West pipeline after a drone strike, sending Brent up 2.32% to $107.04</strong>: the closure of a key Hormuz-bypass route came as Fed-hike odds for Wednesday held in the mid-to-high 80s (~85-86%) and the Fed entered the final stretch of its pre-decision blackout period.", src: "https://www.cnbc.com/2026/09/14/cnbc-daily-open-peace-talks-amid-pipeline-shocks.html", srcName: "CNBC" },
        ...
        { html: "<strong>Macro &mdash; Trump says the US could keep pressuring Iran economically, 'keep the oil like Venezuela'</strong> if the war doesn't end, after Oman postponed Monday's planned Gulf-Iran talks on a Hormuz shipping-lane deal and UKMTO reported a further vessel struck near Qeshm Island.", src: "https://www.cnbc.com/2026/09/14/us-iran-trump-hormuz-gulf-oil-crude-talks-.html", srcName: "CNBC" },
        { html: "<strong>Fixed income &mdash; UK gilts stay pinned near 19-year highs</strong>: the 2-year yield sits at 4.742% (highest since November 2023) and the 10-year at a fresh 19-year peak of 5.295%, even as a unanimous Reuters poll of all 65 economists surveyed still expects the MPC to hold Bank Rate at 3.75% on Thursday.", src: "https://www.investing.com/news/economy-news/bank-of-england-to-hold-rates-show-patience-with-wardriven-inflation-reuters-poll-4891672", srcName: "Reuters (via Investing.com)" },
      ],
    },
    afternoon: {
      label: "Afternoon",
