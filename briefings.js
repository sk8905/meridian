...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-08-12",
      time: "17:38 BST",
      lede: "July CPI landed exactly in line with consensus (headline 0.1% m/m/3.4% y/y, core 0.2% m/m/2.5% y/y), pulling September Fed-hike odds back down to roughly 38&ndash;42% and leaving the S&amp;P 500, Dow and Nasdaq all modestly higher on the day; on the desks, Apollo Sports Capital struck a $2.6bn financing for the New York Yankees, Polus and Hayfin both priced fresh European CLOs, and Kirkland advised KKR on a strategic financing partnership with NVIDIA.",
      bullets: [
        ...
        { html: "<strong>Markets &mdash; equity reaction</strong>: the S&amp;P 500 gained 0.30%, the Dow 0.11% and the Nasdaq 0.59% in a session lifted by the tame CPI print and strong AI/cloud-infrastructure earnings from CoreWeave, Super Micro and Nebius.", src: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-aug-12-2026", srcName: "TheStreet" },
        { html: "<strong>Credit &mdash; Apollo/Yankees</strong>: Apollo Sports Capital struck a $2.6bn financing deal tied to the New York Yankees, the latest sports-finance transaction from Apollo's dedicated sports-lending platform.", src: "https://alternativecreditinvestor.com/2026/08/12/apollo-strikes-2-6bn-ny-yankees-financing-deal/", srcName: "Alternative Credit Investor" },
        { html: "<strong>Credit &mdash; European CLOs</strong>: Polus priced its second new-issue euro CLO of 2026 (tightening senior spreads even as double-Bs showed the effect of recent volatility) and Hayfin priced the second reset of its 2020-vintage European CLO.", src: "https://www.globalcapital.com/securitization/article/2g6fjfxhgjrw62grd5nnk/securitization/clos-europe/polus-tightens-seniors-on-new-clo-but-double-bs-show-war-effect", srcName: "GlobalCapital" },
