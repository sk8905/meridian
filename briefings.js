...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-24",
      time: "00:13 BST",
      lede: "Wednesday's close carries straight into Thursday &mdash; a hawkish Fed reading has lifted October-hike odds to roughly 72% and pushed the 10-year Treasury to its highest since 2007, with sterling sliding to fresh multi-week lows just as Xi Jinping's Washington summit gets under way.",
      bullets: [
        { html: "<strong>Macro &mdash; CME FedWatch-implied odds of an October 28 Fed hike jumped to roughly 71&ndash;73% (from about 53% before the data) after Fed Governor Michael Barr said further rate hikes will likely be needed for a timely return to 2% inflation</strong>, a hawkish read reinforced by Wednesday's blowout flash PMI (Composite 58.4, a 62-month high).", src: "https://www.cnbc.com/2026/09/23/market-sees-next-fed-hike-in-october-following-barr-comments-hot-inflation.html", srcName: "CNBC" },
        { html: "<strong>Macro &mdash; Pantheon Macroeconomics said Wednesday's hotter UK services-price data, running above 4.5% on a three-month annualised basis, is &lsquo;hawkish for the MPC&rsquo; and keeps a November Bank Rate hike &lsquo;on track&rsquo;</strong>, even as the same flash survey showed UK growth slumping to a four-month low of 51.0.", src: "https://www.exchangerates.org.uk/news/47257/2026-09-23-pound-sterling-today-pmi-slowdown-leaves-november-boe-hike-in-play.html", srcName: "Exchange Rates UK" },
        { html: "<strong>Equities &mdash; Wall Street closed broadly lower Wednesday, the S&amp;P 500 down 0.75% to 7,706.03, the Dow off 352 points (-0.68%) to 51,511.59 and the Nasdaq down 1.13% to 26,936.04</strong>, with only energy shares higher on the index as the yield spike and fresh AI-disruption worries weighed ahead of Thursday's Trump-Xi summit.", src: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-sept-23-2026", srcName: "TheStreet" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield closed at 5.135%, its highest since July 2007, while GBP/USD extended its slide to around $1.3272 &mdash; its weakest since early July</strong>, as broad dollar strength carried into the Asian session ahead of Thursday's summit.", src: "https://edition.cnn.com/2026/09/23/investing/us-bond-market-fed", srcName: "CNN Business" },
      ],
    },
    afternoon: {
      label: "Afternoon",
