...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-17",
      time: "17:18 BST",
      lede: "The G7 rate-hike week's second decision landed as expected: the Bank of England held Bank Rate at 3.75% (6&ndash;3) and slowed QT to about &pound;50bn a year, but Governor Bailey warned a hike would follow if the Iran-war energy shock keeps inflation elevated, a day after the Fed's own first hike since 2023.",
      bullets: [
        ...
        { html: "<strong>Equities &mdash; the Nasdaq climbed Thursday</strong> as US markets digested Wednesday's Fed hike, with Treasuries paring their post-decision losses as Chair Warsh's inflation-fighting resolve reassured investors.", src: "https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-sept-17-2026", srcName: "TheStreet" },
        ...
        { html: "<strong>Macro &mdash; Fed Chair Warsh defended Wednesday's hike as a good-news, growth-driven move</strong> rather than a concession to President Trump's repeated calls for cuts, in his first extended remarks since the decision.", src: "https://www.bloomberg.com/news/articles/2026-09-17/trump-denied-rate-cut-as-federal-reserve-targets-war-stoked-inflation", srcName: "Bloomberg" },
        { html: "<strong>Macro &mdash; Goldman Sachs and Citigroup both hardened their BoE calls around today's decision</strong> &mdash; Goldman now sees a 25bp hike in November before a hold, Citi looks for hikes in both November 2026 and February 2027 &mdash; joining Deutsche Bank and Barclays in a firming hawkish consensus.", src: "https://www.kitco.com/news/off-the-wire/2026-09-14/goldman-sachs-sees-boe-rate-hike-november-amid-inflation-concerns", srcName: "Reuters (via Kitco)" },
      ],
    },
  },
