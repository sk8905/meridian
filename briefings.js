...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    afternoon: {
      ...
      date: "2026-09-25",
      time: "14:22 BST",
      lede: "Friday's bond market is speaking louder than the Washington set-piece did &mdash; a resilient US housing print is colliding with the sharpest jump in Treasury volatility in a year, while London edges toward a weekend rebound sterling traders still aren't fully buying.",
      bullets: [
        { html: "<strong>Macro &mdash; Treasury-market volatility is on course for its biggest weekly jump since the April &lsquo;Liberation Day&rsquo; tariff shock</strong>, as the sell-off that has pushed 30-year yields to their highest since 2004 keeps churning through rates markets into the weekend.", src: "https://www.bloomberg.com/news/articles/2026-09-25/treasury-volatility-set-for-biggest-jump-in-year-as-bonds-churn", srcName: "Bloomberg" },
        { html: "<strong>Macro &mdash; US new home sales jumped to an eight-month high in August, up 6.4% to a 684,000 annual pace and well above forecasts</strong>, a resilience signal that cuts against the case for the Fed to pause even as jobless claims hold near multi-month lows.", src: "https://money.usnews.com/investing/news/articles/2026-09-24/us-new-home-sales-jump-to-eight-month-high-in-august", srcName: "Reuters (via U.S. News)" },
        { html: "<strong>Equities &mdash; the FTSE 100 is set for a rebound Friday with sterling holding close to $1.32</strong>, even as gilt yields stay elevated and traders weigh how far the Bank of England's tightening chorus this week will carry into a November move.", src: "https://www.bloomberg.com/news/live-blog/2026-09-25/ftse-100-gilts-pound-yields-what-s-moving-uk-markets-right-now-markets-today", srcName: "Bloomberg" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield is holding near 5.19% as volatility spikes across the curve</strong>, while the UK 2-year gilt sits near 4.77% with sterling still underperforming on doubts over the BoE's tightening follow-through.", src: "https://www.fxstreet.com/news/british-pound-underperforms-this-week-as-experts-doubt-boe-tightening-prospects-202609250806", srcName: "FXStreet" },
      ],
    },
    evening: {
      label: "Evening",
