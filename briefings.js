...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-24",
      time: "20:19 BST",
      lede: "Thursday's bond story shifted from Washington to Threadneedle Street by evening &mdash; a hardening tone from two Bank of England rate-setters pushed UK borrowing costs to their highest since the late 1990s and lifted next-month hike odds sharply &mdash; even as the Fed's own hawkish chorus and a tentative US-Iran de-escalation kept Wall Street's losses in check.",
      bullets: [
        ...
        { html: "<strong>Fixed income &mdash; the 30-year gilt yield touched 5.68% Thursday, its highest since May 1998</strong>, as the BoE deputy governors' hawkish shift compounded a global bond sell-off that has already pushed the 10-year Treasury yield to around 5.14% and the 30-year to its highest since 2004.", src: "https://www.investing.com/news/economy-news/bank-of-england-rate-setters-warn-of-sparks-in-the-tinderbox-4915841", srcName: "Reuters (via Investing.com)" },
      ],
    },
  },
};
