...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    afternoon: {
      ...
      date: "2026-09-24",
      time: "14:25 BST",
      lede: "The Trump-Xi summit is running alongside a fresh round of central-bank hawkishness on both sides of the Atlantic, with the Fed's Williams and the BoE's Lombardelli each flagging more tightening risk just as Treasury yields near 2007 highs keep bleeding into equity futures.",
      bullets: [
        { html: "<strong>Macro &mdash; New York Fed President John Williams said Thursday it's &lsquo;reasonable&rsquo; to expect another rate hike by year-end</strong>, though he stopped short of committing to an October move, saying policymakers still need to weigh incoming data &mdash; CME FedWatch-implied odds of an October hike rose to roughly 77.5% (from 53% a day earlier).", src: "https://www.cnbc.com/2026/09/24/feds-williams-another-rate-hike-by-year-end.html", srcName: "CNBC" },
        { html: "<strong>Macro &mdash; Bank of England Deputy Governor Clare Lombardelli said policy is &lsquo;increasingly likely to need to tighten&rsquo; if elevated energy prices persist</strong>, absent clear evidence of disinflation or weaker activity, speaking in Warsaw hours after the OECD raised its UK 2026 growth forecast while trimming its inflation outlook.", src: "https://www.fxstreet.com/news/bank-of-englands-lombardelli-policy-likely-to-need-to-tighten-if-energy-risks-persist-202609240805", srcName: "FXStreet" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield held near 5.12&ndash;5.13% Thursday, its highest since July 2007, while the 30-year pushed to a fresh post-2004 peak</strong> as the bond-market rout extended into a second day on the hawkish Fed chorus and a weak prior auction.", src: "https://www.cnbc.com/2026/09/24/us-treasury-yields-bonds-fed-inflation.html", srcName: "CNBC" },
        { html: "<strong>Equities &mdash; S&amp;P 500 futures fell 0.4% and Nasdaq 100 futures dropped 0.6% in premarket trading Thursday, with Dow futures off 0.2%</strong>, as surging Treasury yields and hawkish Fed commentary kept traders on edge ahead of the Trump-Xi summit.", src: "https://finance.yahoo.com/markets/stocks/articles/nasdaq-p-500-futures-slide-082555072.html", srcName: "Yahoo Finance" },
      ],
    },
    evening: {
      label: "Evening",
