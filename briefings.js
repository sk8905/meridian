...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-24",
      time: "05:18 BST",
      lede: "Thursday opens with Trump and Xi extending their trade truce at the start of the Beijing leader's Washington state visit, even as a hawkish Fed reading keeps October-hike odds near three-quarters and the 10-year Treasury pinned at its highest since 2007.",
      bullets: [
        { html: "<strong>Macro &mdash; Trump and Xi Jinping agreed to extend their trade truce &mdash; due to expire 10 November &mdash; by two months to 10 January, as Xi arrived in Washington for a three-day state visit</strong> with tariffs, rare-earth exports, Taiwan and Iran atop Thursday's summit agenda.", src: "https://www.wsbtv.com/news/business/trump-xi-jinping/S5CGCQW6N47NPDS5L5DH65NL74/", srcName: "AP" },
        ...
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield closed at 5.135%, its highest since July 2007, while GBP/USD extended its slide to around $1.3272 &mdash; its weakest since early July</strong>, as broad dollar strength carried into the Asian session and a hawkish BoE-hike debate kept sterling on the back foot.", src: "https://edition.cnn.com/2026/09/23/investing/us-bond-market-fed", srcName: "CNN Business" },
      ],
    },
    afternoon: {
      label: "Afternoon",
