...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-09-25",
      time: "00:18 BST",
      lede: "The resilience argument that hawks have been leaning on all week got fresh backing overnight &mdash; a jobless-claims print at its lowest since mid-July &mdash; leaving the Fed's inflation fight no easier even as the bond market that has driven this week's narrative shows no sign of turning.",
      bullets: [
        { html: "<strong>Macro &mdash; weekly US jobless claims fell to 197,000, their lowest since mid-July</strong>, underscoring the still-resilient labour market that hawkish Fed officials including New York's John Williams have cited this week in arguing for a further hike by year-end.", src: "https://www.usnews.com/news/business/articles/2026-09-24/claims-for-unemployment-benefits-drop-to-197-000-the-lowest-since-mid-july-as-layoffs-remain-rare", srcName: "AP (via U.S. News)" },
        { html: "<strong>Macro &mdash; the surging Treasury sell-off is now posing what commentators are calling &lsquo;a brand new problem&rsquo; for Fed Chair Kevin Warsh</strong>, complicating his inflation-fighting message just as a resilient jobs market removes one of the strongest arguments against tightening further.", src: "https://www.cnbc.com/2026/09/24/surging-treasury-yields-are-posing-a-brand-new-problem-for-kevin-warsh-and-the-fed.html", srcName: "CNBC" },
        { html: "<strong>Equities &mdash; Wall Street closed little changed for a second straight session Thursday</strong>, with the modest moves masking a session that saw stocks claw back a much steeper bond-driven slide on hopes for a phased reopening of the Strait of Hormuz.", src: "https://finance.yahoo.com/markets/live/stock-market-today-thursday-september-24-dow-sp-500-nasdaq-080352893.html", srcName: "Yahoo Finance" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield remains pinned near 5.10&ndash;5.15%, its highest since 2007, after touching an intraday high Thursday</strong>, keeping the whole curve outside the two-year above 5% and the average 30-year mortgage rate at 7.37%, its highest since May 2024.", src: "https://www.cnbc.com/2026/09/24/us-treasury-yields-bonds-fed-inflation.html", srcName: "CNBC" },
      ],
    },
    afternoon: {
      label: "Afternoon",
