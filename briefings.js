...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-24",
      time: "18:15 BST",
      lede: "A tentative diplomatic opening &mdash; word that US and Iranian negotiators are exploring a phased reopening of the Strait of Hormuz &mdash; briefly cheered markets Thursday, but it only pared, rather than reversed, a session still dragged down by a bond market grinding to fresh multi-decade highs and a widening Fed hawkish chorus.",
      bullets: [
        { html: "<strong>Macro &mdash; US and Iranian negotiators meeting on the sidelines of the UN General Assembly in New York are exploring a phased path out of their nearly seven-month conflict</strong>, with Tehran reopening the Strait of Hormuz in stages in exchange for Washington lifting its economic blockade, though sources caution neither side wants to surrender leverage first.", src: "https://www.usnews.com/news/world/articles/2026-09-24/us-and-iran-discuss-phased-deal-to-reopen-hormuz-and-end-us-blockade-sources-say", srcName: "Reuters (via U.S. News)" },
        { html: "<strong>Macro &mdash; New York Fed President John Williams said it is &lsquo;reasonable&rsquo; to expect another rate hike by year-end</strong>, adding a fresh voice to the hawkish chorus that has built through the week alongside Governor Barr and Boston's Collins.", src: "https://www.cnbc.com/2026/09/24/feds-williams-another-rate-hike-by-year-end.html", srcName: "CNBC" },
        { html: "<strong>Equities &mdash; the Dow, S&amp;P 500 and Nasdaq pared their session lows to trade down roughly 0.3%, 0.4% and 0.6% respectively on Thursday</strong>, as the Hormuz diplomacy headlines offered some relief from the week's bond-driven risk-off tone even as China's Xi Jinping arrived in Washington for the two leaders' summit.", src: "https://finance.yahoo.com/markets/live/stock-market-today-thursday-september-24-dow-sp-500-nasdaq-080352893.html", srcName: "Yahoo Finance" },
        { html: "<strong>Fixed income &mdash; the 10-year Treasury yield pushed further to around 5.14% Thursday, extending its climb toward a 19-year high</strong>, and the average 30-year mortgage rate jumped 11bp to 7.37% &mdash; its highest since May 2024 &mdash; as the global bond sell-off kept tightening financial conditions.", src: "https://finance.yahoo.com/markets/live/stock-market-today-thursday-september-24-dow-sp-500-nasdaq-080352893.html", srcName: "Yahoo Finance" },
      ],
    },
  },
};
