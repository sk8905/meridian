...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-08-29",
      time: "05:19 BST",
      lede: "Markets are digesting Fed Chair Kevin Warsh's hawkish Jackson Hole debut over the weekend &mdash; inflation still \"too high\" and the Fed has \"more work to do\" &mdash; which pushed fed-funds futures to a 57.5% chance of a 16 September hike and sent US stocks to a lower Friday close even as gilt/Treasury yields firmed; the FT's weekend read flags a wider drift toward financial repression as sovereign debt loads climb. On the desks: two fresh Nishant Kumar (Bloomberg) hedge-fund stories land &mdash; Capula's new quant CTA launch and a fresh Two Sigma founders' arbitration &mdash; while credit's rotating re-verification refreshed Crescent Capital, Coller Capital and NLC (No Limit Capital); legal's most recent tracked judgment remains Friday's Apollo XI v Nexedge Markets freezing-injunction cross-undertaking ruling.",
      bullets: [
        ...
        { html: "<strong>Macro &mdash; a new age of financial repression?</strong>: A weekend FT analysis argues rising sovereign debt loads are pushing governments back toward financial-repression policies &mdash; holding rates below inflation to erode public debt in real terms &mdash; a reversal of decades of financial liberalisation.", src: "https://www.ft.com/content/ba4b940e-4a44-473b-9846-eaba9434b65f", srcName: "Financial Times" },
        { html: "<strong>Credit/HDG &mdash; Capula's new quant CTA launch</strong>: Capula Investment Management hired ex-AQR trader Yao Hua Ooi to launch a new quantitative CTA strategy, the Capula Alternative Markets Alpha Fund (capacity $2bn-$3bn), part of the $32bn macro hedge fund's diversification beyond its core fixed-income relative-value book.", src: "https://www.bloomberg.com/news/articles/2026-08-28/hedge-fund-capula-launches-new-strategy-in-diversification-push", srcName: "Bloomberg" },
        { html: "<strong>Credit/HDG &mdash; Two Sigma founders' fresh arbitration</strong>: Two Sigma co-founders John Overdeck and David Siegel opened two new arbitration disputes &mdash; one alleging undisclosed conflicts in handling a former employee's complaint, the other over the composition of the firm's management committee &mdash; the latest round in their long-running feud.", src: "https://www.bloomberg.com/news/articles/2026-08-27/two-sigma-s-feuding-founders-head-to-arbitration-in-fresh-battle", srcName: "Bloomberg" },
        { html: "<strong>Legal &mdash; Apollo XI v Nexedge Markets</strong>: The High Court (Comm) granted Nexedge's application to enforce Apollo's cross-undertaking in damages and ordered an inquiry into losses from a freezing injunction earlier discharged for breach of the duty of full and frank disclosure &mdash; the desk's most recent tracked banking judgment.", src: "https://caselaw.nationalarchives.gov.uk/ewhc/comm/2026/2240", srcName: "National Archives (Caselaw)" },
      ],
    },
    afternoon: {
      label: "Afternoon",
