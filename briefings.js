...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      bullets: [
        { html: "<strong>Equities &mdash; Wall Street snaps a four-session losing streak</strong>: the Dow rose 1.15% to 53,414.25, the S&amp;P 500 gained 0.96% to 7,718.60 and the Nasdaq added 0.88% to 26,506.99 Friday, with falling oil prices offsetting the hot core CPI print and the resulting jump in Fed-hike bets.", src: "https://finance.yahoo.com/markets/live/stock-market-today-friday-september-11-dow-sp-500-nasdaq-cpi-inflation-082201751.html", srcName: "Yahoo Finance" },
        { html: "<strong>Macro &mdash; hot core CPI pushes Fed-hike odds to a cycle-high ~90%</strong>: August core prices rose 0.3% m/m, a tenth above forecast, in the last major data point before Wednesday's FOMC decision &mdash; bolstering the case for Chair Kevin Warsh's Fed to raise rates.", src: "https://www.bloomberg.com/news/articles/2026-09-11/us-core-cpi-rises-more-than-forecast-bolstering-case-for-hike", srcName: "Bloomberg" },
