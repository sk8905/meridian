...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-09-22",
      time: "20:20 BST",
      lede: "Softer oil is doing quiet work on the rate-hike story into the close &mdash; gold caught a bid as traders trimmed Fed and BoE tightening bets, even as Wall Street's AI-led records hold and Treasury yields sit becalmed ahead of Wednesday's Fed remarks.",
      bullets: [
        { html: "<strong>Macro &mdash; gold edged higher as lower oil prices damped the perceived chance of further central-bank rate hikes</strong>, with the retreat in crude feeding through to a softer near-term tightening outlook.", src: "https://www.bloomberg.com/news/articles/2026-09-22/gold-edges-higher-as-lower-oil-prices-damp-chance-of-rate-hikes", srcName: "Bloomberg" },
        { html: "<strong>Macro &mdash; Deutsche Bank shifted its Bank of England call to two 25bp &lsquo;insurance&rsquo; hikes</strong>, November and February, revising up from its earlier no-further-hikes view on a modest tightening path.", src: "https://www.fxstreet.com/news/bank-of-england-modest-insurance-tightening-path-deutsche-bank-202609221320", srcName: "FXStreet" },
