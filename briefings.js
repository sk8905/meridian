...
export const BRIEFINGS = {
  ...
  slots: {
    morning: {
      ...
      date: "2026-08-19",
      time: "05:25 BST",
      lede: "Asian equities and bonds sold off sharply overnight &mdash; Japanese and Korean stocks slid as bond-market anxiety hit AI-linked chip names and oil extended its advance on an Iran/US stalemate &mdash; while the dollar stayed feeble ahead of Wednesday's FOMC minutes; in credit, Bridgepoint and CIC Private Debt both priced CLO resets and Urban Partners' Velo Capital strategy held a &euro;200m first close for its second Nordics real-estate credit fund; and White &amp; Case advised PPF Group on a joint venture with Live Nation over Prague's O2 arena while Travers Smith advised TruFin on its Playstack disposal.",
      bullets: [
        { html: "<strong>Macro &mdash; Asia selloff</strong>: Japanese and Korean stocks slid as bond-market anxiety hit AI-linked sentiment, with higher yields weighing heavily on chip stocks across the region.", src: "https://www.bloomberg.com/news/articles/2026-08-19/japanese-stocks-slide-as-bond-market-anxiety-hits-ai-sentiment", srcName: "Bloomberg" },
        { html: "<strong>Macro &mdash; oil &amp; dollar</strong>: Oil advanced for a fourth day as the US and Iran remained locked in a stalemate, while the dollar stayed feeble on dwindling rate-hike bets ahead of Wednesday's FOMC minutes.", src: "https://www.bloomberg.com/news/articles/2026-08-18/latest-oil-market-news-and-analysis-for-aug-19", srcName: "Bloomberg" },
        ...
        { html: "<strong>Credit &mdash; Urban Partners</strong>: Urban Partners' Velo Capital credit strategy held a &euro;200m first close of Urban Partners Credit II, a Nordics/Germany whole-loan real-estate credit fund anchored by Danish pension funds Industriens Pension and L&aelig;gernes Pension &amp; Bank.", src: "https://alternativecreditinvestor.com/2026/08/18/urban-partners-raises-e200m-from-danish-pension-funds-for-re-credit-fund-at-first-close/", srcName: "Alternative Credit Investor" },
        { html: "<strong>Legal &mdash; White &amp; Case/PPF</strong>: White &amp; Case advised PPF Group on a partnership with Live Nation covering Prague's O2 arena, O2 universum and Forum Karl&iacute;n.", src: "https://www.whitecase.com/news/press-release/white-case-advises-ppf-group-partnership-live-nation-o2-arena-o2-universum-and", srcName: "White & Case" },
      ],
    },
    afternoon: {
      label: "Afternoon",
