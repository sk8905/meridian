...
export const BRIEFINGS = {
  ...
  slots: {
    ...
    evening: {
      ...
      date: "2026-08-26",
      time: "17:26 BST",
      lede: "July core PCE inflation held exactly in line with consensus at 3.3% y/y while headline PCE ran a touch hot at 3.7% on stalling consumer spending, doing little to shift September Fed rate-hike odds ahead of Friday's Warsh Jackson Hole keynote and Nvidia's after-the-close earnings; in credit, a Cerberus affiliate agreed to buy a SEK6.2bn non-performing loan portfolio from Sweden's Norion Bank; and in legal, Cleary Gottlieb rounded up six H1 2026 English debt-finance rulings while the Court of Appeal handed down further directions in Sucden Financial's long-running dispute with TMT Metals.",
      bullets: [
        { html: "<strong>Macro &mdash; US PCE/GDP</strong>: July core PCE inflation held exactly in line at 0.2% m/m/3.3% y/y, while headline PCE ran a touch hot at 3.7% y/y as consumer spending stalled; the GDP second estimate confirmed Q2 growth unrevised at 1.5%.", src: "https://www.cnbc.com/2026/08/26/core-pce-in-line-but-not-enough-to-lower-fed-rate-hike-expectations.html", srcName: "CNBC" },
        { html: "<strong>Macro &mdash; Dollar/Treasuries</strong>: The dollar posted its biggest one-day gain in four weeks, recouping roughly half its prior buyback-driven losses, while the 10-year Treasury yield edged up to ~4.65% as strategists said the mixed inflation read left September-hike odds little changed.", src: "https://www.bloomberg.com/news/articles/2026-08-26/usd-rises-after-pce-data-recoups-half-of-buyback-losses", srcName: "Bloomberg" },
        { html: "<strong>Macro &mdash; Jackson Hole</strong>: Dollar and bond markets stayed on edge into Fed Chair Kevin Warsh's Friday Jackson Hole keynote, with Treasury Secretary Bessent's bond-buyback intervention having raised the stakes for what he says.", src: "https://www.cnbc.com/2026/08/26/jackson-hole-warsh-bessent-bonds-treasury-dollar.html", srcName: "CNBC" },
        { html: "<strong>Credit &mdash; Cerberus/Norion Bank</strong>: Brocc Finance AB, a Cerberus Capital Management affiliate, agreed to acquire a SEK6.2bn gross non-performing loan portfolio (500,000+ exposures across Sweden, Finland and Norway) from Norion Bank, above book value.", src: "https://www.mynewsdesk.com/se/brocc/pressreleases/brocc-finance-to-acquire-sek-6-punkt-2-bn-non-performing-loan-portfolio-from-norion-bank-3459696", srcName: "Brocc Finance" },
        { html: "<strong>Legal &mdash; Cleary Gottlieb</strong>: Cleary Gottlieb's H1 2026 round-up of six key English debt-finance rulings covers the default-interest/penalty doctrine, GDP-linked security pricing, cross-timezone payment deadlines, sanctions-driven payment suspension and asymmetric jurisdiction clauses.", src: "https://www.clearygottlieb.com/news-and-insights/publication-listing/key-english-rulings-for-debt-finance-h1-2026-round-up", srcName: "Cleary Gottlieb" },
      ],
    },
  },
};
