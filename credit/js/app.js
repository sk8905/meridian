...
import { barChart, donutChart, lineChart, multiLineChart } from "./charts.js?v=20260720-2";
...
} from "./shared.js?v=20260720-2";
import { viewFund, viewManager, viewClo, viewLp } from "./detail.js?v=20260720-2";
...
import("/palette.js?v=20260719-3").then((m) => m.mountPalette()).catch(() => {});
