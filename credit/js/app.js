...
import { barChart, donutChart, lineChart, multiLineChart } from "./charts.js?v=20260721-5";
...
import { viewFund, viewManager, viewClo, viewLp } from "./detail.js?v=20260721-1";
...
import { feedBodyHTML, feedSrcBarHTML, feedEmptyHTML, attachFeedClicks, byFeedDesc } from "/feed.js?v=20260721-10";
...
import("/palette.js?v=20260721-11").then((m) => m.mountPalette()).catch(() => {});
