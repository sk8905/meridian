// AUTO-PORTED from macro/js/app.js for the v2 SPA. Render code verbatim;
// shell wiring changed: injected container, no chrome boot, active-tab-guarded
// listeners. Hash sub-routing unchanged.

import { UPDATED, META, OUTLOOK, CYCLE, BUBBLE, SUMMARY, YIELD_CURVE, ALERTS, NEWS, RELEASES, COMMENTARY, ARTICLES, MATWALL, EARNINGS } from "/macro/js/content.js?v=20260723-2";
...
import { MONTHS, MONTHS_FULL, WEEKDAYS, isoToDate, fmtDay, fmtDayGB, fmtWeekday, fmtDate,
  ...
  MAC_IND_ORDER, MACRO_DATA, setMacroData, macroMatrixHtml, macroDetailHtml } from "/macro/js/shared.js?v=20260722-4";
import { macroDashPane, loadYieldCurve, cockpitInds } from "/macro/js/dashboard.js?v=20260722-9";
import { feedBodyHTML, feedSrcBarHTML, feedEmptyHTML, attachFeedClicks, onLiveWire, liveDesk } from "/feed.js?v=20260724-1";
...
on(document, "click", (e) => { if (e.target.closest("#chart-export")) exportChartPng(); });
