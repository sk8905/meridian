...
// =============================================================================
import { UPDATED, META, OUTLOOK, CYCLE, BUBBLE, SUMMARY, YIELD_CURVE, ALERTS, NEWS, RELEASES, COMMENTARY, ARTICLES, MATWALL, EARNINGS } from "./content.js?v=20260721-2";
...
import("/palette.js?v=20260719-7").then((m) => m.mountPalette()).catch(() => {});
