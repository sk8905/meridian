...
export const OUTLOOK = {
  us: {
    ...
    bottomLine: "The 29 July hike risk ticked back up to roughly 24% (CME FedWatch) on the morning of 22 July, from ~16–17% a day earlier, after Secretary of State Rubio said Iran is 'not serious about talks' and the war opened two further oil-supply fronts (Houthi-forced Red Sea tanker diversions; Kazakhstan's Black Sea CPC halt), pushing Brent to a fresh five-week-plus high. September-meeting hike odds stay the more persistent risk (~69-73%), and a Reuters poll of 104 economists unanimously expects a 29 July hold but puts 2026-hike odds at 66%. Equities have so far shrugged off the fresh escalation — chip names extended their rebound (Kospi +~5.9%) even as oil jumped, a further sign of narrow, complacent AI-led positioning.",
    ...
    fedwatch: {
      ...
      note: "Implied from 30-Day Fed Funds futures. Ticked back up to ~24% hike odds on the morning of 22 Jul (from ~16-17% a day earlier) after Secretary of State Rubio said Iran is 'not serious about talks' and the war opened two further oil-supply fronts (Houthi-forced Red Sea tanker diversions; Kazakhstan's Black Sea CPC halt), still well down from the ~46.5% peak on 13 Jul. September-meeting hike odds eased only slightly to ~69% (from ~73% on 18 Jul, ~59% a few days before that and just 26% in mid-June). A Reuters poll of 104 economists (17-21 Jul) unanimously expects a 29 Jul hold, but 66% now call a 2026 hike likely.",
    },
    dots: {
  ...
  uk: {
    ...
    bottomLine: "Next move a hold on 30 July at 3.75%; markets now fully price a 25bp hike by year-end (most likely December). June CPI cooled more than expected to 2.6% (from 2.8%), but core CPI held at 2.6% (above the 2.5% forecast) and services inflation eased only modestly to 3.6% — a mixed print that keeps the MPC's hawkish dissent alive even as economists warn a 13% Ofgem price-cap rise will push headline CPI back above 3% later this year. Burnham/Healey's VAT cut on household electricity (from October) trims CPI by an estimated 0.10pp, a small disinflationary offset; the 10-year gilt yield held just above 5% as of 21 July, with a fresh Iran-driven oil spike on 22 July (Brent above $91/bbl) an additional inflation risk into the 30 July decision.",
  },
  sources: [
...
export const SUMMARY = {
  outlook: {
    us: "Fed on hold at 3.50–3.75%; 29 July hike odds ticked back up to ~24% (CME FedWatch, morning of 22 Jul) from ~16-17% a day earlier, after Secretary of State Rubio said Iran is 'not serious about talks' and the war opened two further oil-supply fronts (Houthi-forced Red Sea tanker diversions; Kazakhstan's Black Sea CPC halt), pushing Brent above $91/bbl. September-hike odds stay the bigger risk (~69-73%); a Reuters poll of 104 economists unanimously expects a 29 July hold but puts 2026-hike odds at 66%. Chip stocks kept rallying (Kospi +~5.9%) even as oil jumped, a further narrow-leadership complacency signal.",
    uk: "BoE holding at 3.75%; markets now fully price a 25bp hike by year-end (most likely December). June CPI cooled more than expected to 2.6% (from 2.8%, vs 2.7% forecast), but core CPI held at 2.6% (above 2.5% forecast) and services inflation eased only modestly to 3.6% — a mixed print, with economists warning a 13% Ofgem price-cap rise will push headline CPI back above 3% later this year. Burnham/Healey's VAT cut on household electricity (from October) trims CPI ~0.10pp; the 10-year gilt yield held just above 5% as of 21 July, and hawkish dissents persist ahead of the 30 July decision.",
  },
  cycle: {
