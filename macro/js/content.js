...
export const OUTLOOK = {
  us: {
    ...
    body: [
      ...
      "President Trump escalated further later on 22 July, saying the US will <strong>'bomb and destroy'</strong> an Iranian bridge or power plant — including in Tehran itself — every time Iran fires on a ship in the Strait of Hormuz, a sharper threat than the earlier Hormuz-toll dispute; Iran said it would retaliate against regional energy infrastructure in response. Brent settled near <strong>$94.9–95/bbl</strong> (WTI ~$88), up as much as 4.8% on the day and its highest close since 8 June, while the US 10-year Treasury yield edged up to ~4.64-4.65% and the 30-year climbed to ~5.14% — its longest stretch above 5% since 2007. CME FedWatch's 29 July hike odds held around 24% into the close, with September-hike odds easing only slightly to ~69%. US equities nonetheless closed higher — Dow +0.74% to 52,224.64, S&P 500 +0.89% to 7,509.20, Nasdaq +1.29% to 25,837.21 — as the Philadelphia Semiconductor Index jumped ~5.2% ahead of Alphabet's and Tesla's after-the-close results, a further sign of narrow, AI-led complacency toward the widening war. Separately, the Pentagon held a dignified-transfer ceremony at Dover Air Force Base for four US service members killed in the conflict, which Defense Secretary Hegseth said has cost about $37.5bn to date.",
      "Alphabet and Tesla reported after Wednesday's close: Alphabet beat revenue estimates but lifted planned 2026 AI capital spending to as much as $205bn, and Tesla's free cash flow turned negative (a $1.1bn deficit) on a 142% jump in capex — both stocks fell despite otherwise solid results as investors focused on the spending, not the beat, a sign the market's AI-capex tolerance is thinning even before the 29 July decision. Separately overnight, Iran-backed Houthi militants said they struck two Saudi-flagged crude tankers with missiles and drones in the Red Sea — turning their earlier blockade threat into an actual attack — with UK maritime authorities confirming a vessel hit and on fire roughly 70 nautical miles southwest of Al Shuqaiq; Brent extended its rally toward <strong>$96/bbl</strong>, a fresh six-week high, as US forces carried out a 12th consecutive night of strikes on Iran and both sides continued to downplay prospects for renewed talks.",
    ],
    bottomLine: "The 29 July hike risk held around 24% (CME FedWatch) through Wednesday's close after President Trump threatened to bomb an Iranian bridge or power plant every time Iran fires on a Hormuz-transiting ship — a sharper escalation than the earlier toll dispute — pushing Brent to ~$94.9-95/bbl, its highest close since 8 June. September-meeting hike odds stay the more persistent risk (~69%), and a Reuters poll of 104 economists unanimously expects a 29 July hold but puts 2026-hike odds at 66%. Equities have so far shrugged off the fresh escalation — US indices closed higher (Nasdaq +1.29%) and the Philadelphia Semiconductor Index jumped ~5.2% even as oil surged, a further sign of narrow, complacent AI-led positioning ahead of Wednesday's Alphabet and Tesla earnings. Both stocks fell after those results despite topline beats, as investors focused on sharply higher AI capex guidance instead; oil extended its climb toward $96/bbl into Thursday after Houthi militants turned their Red Sea blockade threat into an actual strike on two Saudi tankers, keeping the oil-driven inflation risk to the July/September decisions squarely alive.",
  ...
  sources: [
    ...
    ["Trading Economics — UK 10-Year Government Bond Yield, 22 Jul 2026", "https://tradingeconomics.com/united-kingdom/government-bond-yield"],
    ["Yahoo Finance — Bond yields rise as elevated oil prices reignite threat of 'renewed pressure on inflation', 22 Jul 2026", "https://finance.yahoo.com/markets/article/bond-yields-rise-as-elevated-oil-prices-reignite-threat-of-renewed-pressure-on-inflation-162442976.html"],
    ["CNBC — Alphabet earnings takeaways: Q2 revenue beats, GOOGL stock sinks on 2026 capex hike, 22 Jul 2026", "https://www.cnbc.com/2026/07/22/google-earnings-q2-goog-live-updates.html"],
    ["CNBC — Houthis claim strikes on Saudi Arabian oil tankers in Red Sea as Iran conflict expands, 23 Jul 2026", "https://www.cnbc.com/2026/07/23/iran-war-us-trump-houthis-red-sea-oil.html"],
    ["NBC News — Oil surges past $95 as U.S. downplays Iran diplomacy and 2nd key trade route is disrupted, 22 Jul 2026", "https://www.nbcnews.com/business/business-news/oil-prices-brent-gas-iran-war-trump-hormuz-red-sea-houthis-rcna588671"],
    ["CNN — Live updates: US-Iran strikes; conflict widens with Houthis claiming Red Sea attacks, 23 Jul 2026", "https://www.cnn.com/2026/07/23/world/live-news/iran-war-trump"],
  ],
};
...
export const ALERTS = [
  { id: "g-houthi-tanker-strike-2026-07-23", kind: "Markets", title: "Houthi militants turned their Red Sea blockade threat into an actual attack, striking two Saudi-flagged crude tankers with missiles and drones (one hit and on fire ~70nm SW of Al Shuqaiq); Brent extended its rally toward $96/bbl — a fresh six-week high — as the US carried out a 12th consecutive night of strikes on Iran.", href: "#/bubble", date: "2026-07-23" },
  { id: "g-alphabet-tesla-capex-shock-2026-07-23", kind: "Bubble risk", title: "Alphabet and Tesla both fell despite beating revenue estimates after Wednesday's close: Alphabet lifted planned 2026 AI capex to as much as $205bn and Tesla's free cash flow turned negative ($1.1bn deficit) on a 142% capex jump — investors punished the spending guidance over the beat, a sign AI-capex tolerance is thinning ahead of the 29 July FOMC decision.", href: "#/bubble", date: "2026-07-23" },
...
export const SUMMARY = {
  outlook: {
    us: "Fed on hold at 3.50–3.75%; 29 July hike odds held around ~24% (CME FedWatch) through Wednesday's close, up from ~16-17% at the start of the week, after President Trump threatened to bomb an Iranian bridge or power plant every time Iran fires on a Hormuz ship — pushing Brent to ~$94.9-95/bbl, its highest close since 8 June. September-hike odds stay the bigger risk (~69%); a Reuters poll of 104 economists unanimously expects a 29 July hold but puts 2026-hike odds at 66%. Alphabet and Tesla both fell after Wednesday's close despite topline beats, as investors focused on sharply higher 2026 AI capex guidance; oil extended its climb toward $96/bbl into Thursday after Houthi militants struck two Saudi tankers in the Red Sea, turning their blockade threat into an actual attack and keeping the oil-driven inflation risk alive into the 29 July decision.",
...
export const ARTICLES = {
  ...
  items: [
    ...
    {"title":"Oil surges past $95 as U.S. downplays Iran diplomacy and 2nd key trade route is disrupted","source":"NBC News","date":"2026-07-22","url":"https://www.nbcnews.com/business/business-news/oil-prices-brent-gas-iran-war-trump-hormuz-red-sea-houthis-rcna588671","blurb":"Brent topped $95 for the first time in six weeks as Washington played down prospects for near-term Iran talks and Houthi militants threatened a second Red Sea shipping route."},
    {"title":"Alphabet earnings takeaways: Q2 revenue beats, GOOGL stock sinks on 2026 capex hike","source":"CNBC","date":"2026-07-22","url":"https://www.cnbc.com/2026/07/22/google-earnings-q2-goog-live-updates.html","blurb":"Alphabet's revenue beat forecasts, but shares slid after the company lifted planned 2026 AI capital spending to as much as $205bn, intensifying investor scrutiny of hyperscaler spending."},
    {"title":"Stock Market Today, July 22: Nasdaq Slides Prior to Tesla and Alphabet's Earnings After Market Close","source":"Yahoo Finance","date":"2026-07-22","url":"https://finance.yahoo.com/markets/stocks/articles/stock-market-today-july-22-221042092.html","blurb":"The Nasdaq underperformed as oil's climb toward $95 pressured growth stocks ahead of Tesla's and Alphabet's after-the-close results."},
    {"title":"Trump administration keeps testing trade authorities as tariffs evolve","source":"Axios","date":"2026-07-21","url":"https://www.axios.com/2026/07/21/trump-tariffs-imports-canada","blurb":"The administration is testing a new legal basis for tariffs — including an unused Smoot-Hawley provision against Canada — as its temporary global 10% levy nears its Friday expiry."},
    {"title":"Healey challenges Cabinet to find cuts","source":"CityAM","date":"2026-07-21","url":"https://www.cityam.com/healey-challenges-cabinet-to-find-cuts/","blurb":"Chancellor John Healey pressed Cabinet colleagues to find further savings just hours after criticism that Burnham's VAT cut on electricity was 'unfunded'."},
    {"title":"Oil prices climb after tanker struck off Saudi Arabia, Trump escalates Iran threats","source":"CNBC","date":"2026-07-23","url":"https://www.cnbc.com/2026/07/23/oil-prices-today-wti-brent-trump-iran-hormuz.html","blurb":"Brent extended its rally after a tanker was struck off the Saudi coast, with Trump reiterating threats to strike Iranian infrastructure if Hormuz shipping is targeted again."},
    {"title":"Warsh Confuses Traders, Makes Them Guess Next Week's Rate Move","source":"Bloomberg","date":"2026-07-22","url":"https://www.bloomberg.com/news/articles/2026-07-22/warsh-leaves-bond-traders-in-the-dark-on-next-week-s-rate-move","blurb":"New Fed Chair Kevin Warsh's guarded public remarks have left rates traders split on whether the 28-29 July FOMC meeting produces a hold or a hike."},
    {"title":"U.S. 10-year Treasury yield rises as traders reassess Fed rate hike bets","source":"CNBC","date":"2026-07-22","url":"https://www.cnbc.com/2026/07/22/treasury-yields-fed-rate-hike-bets.html","blurb":"Yields climbed as elevated oil prices and a hawkish repricing of Fed expectations weighed on Treasuries ahead of next week's decision."},
    {"title":"UK Gilt Yields Hit Two-Month High as Oil Surges","source":"TradingEconomics","date":"2026-07-22","url":"https://www.tradingview.com/news/te_news:568138:0-uk-gilt-yields-hit-two-month-high-as-oil-surges/","blurb":"The 10-year gilt yield touched its highest since May as rebuilding BoE-hike bets combined with the oil-driven inflation scare to pressure UK bonds."},
    {"title":"Sen. Wyden introduces bill to curb Trump's tariff powers","source":"CNBC","date":"2026-07-22","url":"https://www.cnbc.com/2026/07/22/trump-tariffs-wyden-bill-congress.html","blurb":"The Democratic senator's bill would create a congressional tariff committee and a separate USTR agency, pushing back on the administration's use of emergency tariff powers."},
    {"title":"Latest Oil Market News and Analysis for July 23","source":"Bloomberg","date":"2026-07-22","url":"https://www.bloomberg.com/news/articles/2026-07-22/latest-oil-market-news-and-analysis-for-july-23","blurb":"Rolling coverage of crude's rally after Houthi attacks on Saudi tankers in the Red Sea widened the war-risk premium already priced into oil markets."},
    {"title":"Fuel Prices: Iran Isn't the Only Conflict Vexing the Oil Market","source":"Bloomberg Opinion","author":"Javier Blas","date":"2026-07-13","url":"https://www.bloomberg.com/opinion/articles/2026-07-13/fuel-prices-iran-isn-t-the-only-conflict-vexing-the-oil-market","blurb":"Blas argues supply risks beyond the Strait of Hormuz — from Russia's refining capacity to West African disruptions — are keeping crude traders on edge."},
    {"title":"Americans' inflation outlook is still high, per NY Fed survey","source":"Axios","date":"2026-07-07","url":"https://www.axios.com/2026/07/07/rates-inflation-consumers-fed","blurb":"Household inflation expectations ticked up again in the New York Fed's latest survey, complicating the central bank's messaging on the path ahead."},
    {"title":"A July rate hike from the Fed? The odds are rising","source":"CNBC","date":"2026-07-13","url":"https://www.cnbc.com/2026/07/13/-a-july-rate-hike-from-the-fed-the-odds-are-rising.html","blurb":"Market-implied odds of a hike at the Fed's July meeting climbed as sticky inflation data and the oil shock revived tightening bets."},
    {"title":"Trump Says U.S. Will Bomb Key Infrastructure 'Any Time' Iran Shoots At Ships In Strait Of Hormuz","source":"Forbes","author":"Sara Dorn","date":"2026-07-22","url":"https://www.forbes.com/sites/saradorn/2026/07/22/trump-says-us-will-bomb-key-infrastructure-any-time-iran-shoots-at-ships-in-strait-of-hormuz/","blurb":"Trump vowed to destroy an Iranian bridge or power plant — including in Tehran — every time Iran fires on a Hormuz-transiting ship, a sharper threat than the earlier cargo-toll dispute; Iran said it would hit regional energy infrastructure in response."},
    {"title":"Oil price hits $95, rate hike odds rise ahead of Alphabet earnings","source":"Yahoo Finance","date":"2026-07-22","url":"https://finance.yahoo.com/energy/articles/oil-price-hits-95-rate-113143493.html","blurb":"Brent touched $95 and CME FedWatch's 29 July hike odds rose to roughly 24% (September ~69%) as Trump's Hormuz threat and an 11th night of US strikes on Iran revived inflation concern."},
    {"title":"Bond yields rise as elevated oil prices reignite threat of 'renewed pressure on inflation'","source":"Yahoo Finance","date":"2026-07-22","url":"https://finance.yahoo.com/markets/article/bond-yields-rise-as-elevated-oil-prices-reignite-threat-of-renewed-pressure-on-inflation-162442976.html","blurb":"The US 10-year yield reached 4.65% and the 30-year climbed to 5.14% — its longest stretch above 5% since 2007 — as Brent hovered near $93-95 on the widening US-Iran conflict."},
    {"title":"Dow Jones Shrugs Off Oil Shock While Nasdaq Takes a Breather","source":"The Motley Fool","date":"2026-07-22","url":"https://www.fool.com/investing/2026/07/22/dow-jones-shrugs-off-oil-shock-while-nasdaq-rises/","blurb":"Blue chips extended gains even as Brent surged toward $94 on Trump's Iran-infrastructure threat, with Alphabet and Tesla results due after the close."},
    {"title":"4 US soldiers killed in Iran war return to American soil","source":"Military Times","date":"2026-07-22","url":"https://www.militarytimes.com/news/your-military/2026/07/22/4-us-soldiers-killed-in-iran-war-return-to-american-soil/","blurb":"President Trump attended a Dover Air Force Base dignified-transfer ceremony for four US service members killed in Jordan and Iraq; Defense Secretary Hegseth put the war's cost to date at about $37.5bn."},
    {"title":"What the New UK Chancellor Means for the UK Economy","source":"Project Syndicate","author":"Mohamed A. El-Erian","date":"2026-07-22","url":"https://www.project-syndicate.org/commentary/what-john-healey-appointment-as-chancellor-means-for-uk-economy-by-mohamed-a-el-erian-2026-07","blurb":"El-Erian argues John Healey's Treasury experience gives him room for a pro-growth agenda, but the appointment alone does not resolve the fiscal arithmetic confronting gilt investors and the MPC."},
    {"title":"New U.K. finance minister calms market but investors see more tax and debt ahead","source":"The Japan Times","date":"2026-07-22","url":"https://www.japantimes.co.jp/business/2026/07/22/uk-finance-minister-market-tax-debt/","blurb":"Healey's appointment eased immediate gilt-market jitters, but analysts say the underlying pressure for further borrowing or tax rises remains unresolved."},
