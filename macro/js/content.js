...
export const SUMMARY = {
  outlook: {
    ...
    uk: "BoE holding at 3.75%; markets now fully price a 25bp hike by year-end (most likely December). Burnham/Healey's first policy move — a self-funded VAT cut on household electricity to 0% from October — trims CPI ~0.10pp, a mild disinflationary offset even as the 10-year gilt yield (~5.025%) stays near its Burnham-era highs and hawkish dissents persist.",
  },
  cycle: {
