...
export const EARNINGS = {
  weeks: [
    { label: "Last week \u00b7 13\u201317 Jul", days: [
      { date: "2026-07-14", rows: [
        { t: "JPM", n: "JPMorgan", tag: "Banks \u00b7 Dow", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$5.55", estRev: "$48.8bn", estEbitda: null, actEps: "$7.70", actRev: "$57.3bn", actEbitda: null, px: null, note: "record $21.2bn profit; all five majors beat" },
        { t: "GS", n: "Goldman Sachs", tag: "Banks \u00b7 Dow", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$14.47", estRev: "$16.49bn", estEbitda: null, actEps: "$20.98", actRev: "$20.34bn", actEbitda: null, px: null, note: "best quarter in its history" },
      ] },
      { date: "2026-07-15", rows: [
        { t: "MS", n: "Morgan Stanley", tag: "Banks \u00b7 S&P 500", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$2.89", estRev: "$19.38bn", estEbitda: null, actEps: "$3.46", actRev: "$21.3bn", actEbitda: null, px: null, note: "record equities revenue" },
        { t: "ASML", n: "ASML", tag: "Chips \u00b7 AI capex", when: null, held: [{ etf: "IGWD", w: null }], estEps: null, estRev: null, estEbitda: null, actEps: "\u20ac7.59", actRev: "\u20ac9.3bn", actEbitda: null, px: null, note: "2026 sales guided \u20ac43\u201345bn" },
      ] },
      { date: "2026-07-16", rows: [
        { t: "TSM", n: "TSMC", tag: "Chips \u00b7 EM", when: null, held: [{ etf: "EMEE", w: "9.74%" }], estEps: "$3.83", estRev: "$40bn", estEbitda: null, actEps: "$4.31/ADR", actRev: "$40.2bn", actEbitda: null, px: "-5%", note: "record 67.7% gross margin" },
      ] },
    ] },
    { label: "This week \u00b7 20\u201324 Jul", days: [
      { date: "2026-07-21", rows: [
        { t: "SCHW", n: "Charles Schwab", tag: "Banks/brokers \u00b7 S&P 500", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$1.55", estRev: "$6.89bn", estEbitda: null, actEps: null, actRev: null, actEbitda: null, px: null },
        { t: "COF", n: "Capital One", tag: "Banks \u00b7 S&P 500", when: null, held: [{ etf: "IGWD", w: null }], estEps: "$4.89", estRev: "$15.7bn", estEbitda: null, actEps: null, actRev: null, actEbitda: null, px: null },
        { t: "KO", n: "Coca-Cola", tag: "Staples \u00b7 Dow", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$0.93", estRev: "$13.13bn", estEbitda: null, actEps: null, actRev: null, actEbitda: null, px: null },
        { t: "VZ", n: "Verizon", tag: "Telecoms \u00b7 Dow", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$1.26", estRev: "$35.5bn", estEbitda: "$13.7bn", note: "consensus +7.7% y/y; EBITDA cons +8.1%", actEps: null, actRev: null, actEbitda: null, px: null },
        { t: "RTX", n: "RTX", tag: "Defence \u00b7 S&P 500", when: "Pre-mkt", held: [{ etf: "IGWD", w: null }], estEps: "$1.66", estRev: "$23.08bn", estEbitda: null, actEps: null, actRev: null, actEbitda: null, px: null },
      ...
      { date: "2026-07-22", rows: [
        ...
        { t: "TSLA", n: "Tesla", tag: "Mag 7", when: "After close", held: [{ etf: "IGWD", w: "1.33%" }], estEps: "$0.47", estRev: "$27.6bn", estEbitda: null, note: "consensus +17.5% y/y; rev = co-compiled consensus", actEps: null, actRev: null, actEbitda: null, px: null },
        ...
        { t: "NOW", n: "ServiceNow", tag: "AI/software \u00b7 S&P 500", when: "After close", held: [{ etf: "IGWD", w: null }], estEps: "$0.86", estRev: "$3.82bn subs", estEbitda: null, note: "rev = subscription guide; watch cRPO >19.5%", actEps: null, actRev: null, actEbitda: null, px: null },
      ] },
      { date: "2026-07-23", rows: [
        { t: "INTC", n: "Intel", tag: "Chips \u00b7 Nasdaq 100", when: "After close", held: [{ etf: "IGWD", w: null }], estEps: "$0.10", estRev: "$14.4bn", estEbitda: null, note: "consensus +138.5% y/y", actEps: null, actRev: null, actEbitda: null, px: null },
        { t: "BX", n: "Blackstone", tag: "Asset mgr \u00b7 S&P 500", when: null, held: [{ etf: "IGWD", w: null }], estEps: "$1.34", estRev: null, estEbitda: null, actEps: null, actRev: null, actEbitda: null, px: null },
      ] },
  ...
  foot: "N/R = not reported: no published figure \u2014 banks report no EBITDA, and sell-side consensus EBITDA sits behind paid terminals (Visible Alpha, Bloomberg), so it is rarely quotable; Verizon is the exception this week. NOW revenue is the company's subscription-revenue guide; TSLA revenue is Tesla's company-compiled consensus. ETF labels show the stock's fund/index weight where published (MSCI & BlackRock factsheets); other holdings are label-only. OpenAI, Anthropic & SpaceX are private \u2014 no earnings releases; their funding news runs in the wire. WMVG (min-vol) holds none of these reporters; COMM holds commodity futures, not equities.",
  srcs: [
