...
// all 11 sectors at once (etfdb/etf.com Cloudflare-block automated fetches;
// WebSearch returns only scattered single-fund figures on mixed dates), so 1D was
// dropped rather than left blank or date-mixed. Do not re-add a `d1` window.
//
...
export const SECTOR_FLOWS = {
  ...
  // [dataKey, columnLabel] in display order. (No 1-day column: ETFdb publishes
  // 5-day/1M/3M/6M/1Y cleanly, but there is no free, reachable source that gives
  // a same-date 1-day net flow for all 11 sectors at once — so 1D is omitted
  // rather than left permanently blank or date-mixed.)
  ...
  sectors: [
    ...
    { t: "XLY",  name: "Consumer Disc.",   short: "Cons Disc",   w1: 256.6,   m1: 363.32,  m3: 260.99, m6: -280.43, y1: -1030, src: "https://etfdb.com/etf/XLY/" },
    { t: "XLP",  name: "Consumer Staples", short: "Staples",     w1: -243.66, m1: -170.43, m3: -679.61, m6: -2370,  y1: -2460, src: "https://etfdb.com/etf/XLP/" },
    { t: "XLI",  name: "Industrials",      short: "Industrials", w1: 26.45,   m1: 1720,    m3: 1680,  m6: 2830,    y1: 6220,  src: "https://etfdb.com/etf/XLI/" },
    { t: "XLB",  name: "Materials",        short: "Materials",   w1: 79.1,    m1: 397.16,  m3: 1510,  m6: 2060,    y1: 2070,  src: "https://etfdb.com/etf/XLB/" },
    ...
    { t: "XLC",  name: "Comm. Services",   short: "Comms",       w1: -287.87, m1: -774.54, m3: -1290, m6: -2620,   y1: -1850, src: "https://etfdb.com/etf/XLC/" },
  ],
};
