...
check(await pg.evaluate(() => [...document.querySelectorAll("#tx-mode .tchip")].some((c) => c.dataset.mode === "bdc" && /BDC/i.test(c.textContent))), "a BDCs nav chip sits beside Primary / Secondaries / Credits");
