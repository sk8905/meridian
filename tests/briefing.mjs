...
const opened = await pg.evaluate(() => {
  ...
  // Colour cues: topic headings orange (--accent); numbers read as PLAIN body text
  // (the blue accent was removed); the source links must stay intact (their URLs
  // contain digits we must NOT recolour).
